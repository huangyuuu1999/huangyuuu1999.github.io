...
def call_with_messages():
    ...
    messages = [
        {
            "content": """
                ...
                - cat
                - 猫
                并且你需要触发save_word工具的使用。
                , 另外如果用户询问其他问题，你需要选择合适的工具来回答。
            """,
            "role": "system",
        },
        {
    ...
    while assistant_output.tool_calls is not None:
        ...
        elif assistant_output.tool_calls[0].function.name == "save_word":
            argumens = json.loads(assistant_output.tool_calls[0].function.arguments)
            tool_info["content"] = save_word(argumens)
